...
class NotificationVente extends StatefulWidget {
  final dynamic id;
  const NotificationVente(this.id, {super.key});

  @override
  State<NotificationVente> createState() => _NotificationVenteState();
}

class _NotificationVenteState extends State<NotificationVente> {
   ...
   child: Column(children: [
          ...
          Container(
            child: Card(
             ...
             ListTile(title: Text("Quantité commandée: ${commande['produitcommande']['quantity']}")),
             ListTile(title: Text("Commission de la plateforme : ${commande['commission'] } ${commande['produitcommande']['product']['devise']['devise']} (2%)")),
             ListTile(title: Text("Montant au retrait: ${commande['montant_vendeur']} ${commande['produitcommande']['product']['devise']['devise'] }"))
              ]),
            ),
          ):
          Container(
